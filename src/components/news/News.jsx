...
<div className="lg:row-span-2 lg:col-span-2 relative overflow-hidden group bg-white border shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7]">
...
<div className="row-span-1 col-span-1 relative overflow-hidden group bg-white border shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7]">
