    ...
    return (
        <div>
            <div className="flex flex-col items-center justify-center bg-[url(https://i.ibb.co/WKY7MrF/image-4.jpg)] bg-cover bg-fixed bg-center bg-no-repeat h-[60vh] mt-16">
                <h1 className="text-white lg:text-3xl md:text-xl text-lg font-semibold mb-4" data-aos="zoom-in">Create Your Beautiful Garden With Us</h1>
                <h1 className="text-white lg:text-3xl md:text-xl text-lg font-semibold mb-4" data-aos="zoom-out">Please Call : (+88) 01234 56 78 90</h1>
