    ...
    return (
        ...
        lg:-mt-12 md:mt-14 mt-14'>
            <div className="flex items-center gap-4 bg-gradient-to-r from-black via-[#02250e] to-[#036424] p-6 rounded-2xl">           
                <div>
                    <img className='w-10' data-aos="zoom-in" src="https://i.ibb.co/DpjnwDB/counter-img-1.png" alt="" />
                </div>
                <div>
            ...
            <div className="flex items-center gap-4 bg-gradient-to-r from-black via-[#02250e] to-[#036424] p-6 rounded-2xl">           
                <div>
                    <img className='w-10' data-aos="zoom-in"src="https://i.ibb.co/mtBWsrH/gardening-counter-2.png" alt="" />
                </div>
                <div>
                <h1 className="text-3xl text-white font-semibold"><CountUp
                    end={70}
            ...
            <div className="flex items-center gap-4 bg-gradient-to-r from-black via-[#02250e] to-[#036424] p-6 rounded-2xl">           
                <div>
                    <img className='w-10' data-aos="zoom-in" src="https://i.ibb.co/9qPWL9f/gardening-like.png" alt="" />
                </div>
                <div>
                <h1 className="text-3xl text-white font-semibold"><CountUp
                    end={20}
            ...
            <div className="flex items-center gap-4 bg-gradient-to-r from-black via-[#02250e] to-[#036424] p-6 rounded-2xl">           
                <div>
                    <img className='w-10' data-aos="zoom-in" src="https://i.ibb.co/vmXb4N8/gardening-winner.png" alt="" />
                </div>
                <div>
                <h1 className="text-3xl text-white font-semibold"><CountUp
                    end={17}
