...
const Features = () => {
    return (
        <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 justify-center gap-6 mx-20 pt-14">
            <div className="feature-card group overflow-hidden hover:scale-105 transition-transform rounded-3xl space-y-3 p-10 items-center text-center mx-auto bg-black hover:bg-gradient-to-b from-black via-[#02250e] to-[#036424]">
