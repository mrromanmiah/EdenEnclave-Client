    ...
    return (
        <div className="lg:flex items-center mt-16 lg:mx-20 md:mx-10 mx-5 gap-12">
            ...
            <div className="grid grid-cols-2 gap-3 lg:w-1/2">
                ...
                <div>
                    <img src="https://i.ibb.co/cN1hZGt/beautiful-redhead-smiling-florist-apron-working-with-flowers-young-lady-standing-with-big-flower-han.jpg" alt="Image 2" className="w-full h-full object-cover rounded-tr-3xl rounded-bl-3xl" />
                </div>
                <div>
                    <img src="https://i.ibb.co/2SLwrFj/plants-gardening-tools-close-up-1.jpg" alt="Image 3" className="w-full h-full object-cover rounded-br-3xl rounded-tl-3xl" />
                </div>
            </div>
