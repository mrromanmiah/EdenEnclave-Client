                ...
                <div className="space-y-2">
                    ...
                    <div className="lg:w-1/2 md:w-1/2 w-full">
                        <swiper-container>
                            ...
                            <swiper-slide><div className="pr-10 pt-5">
                                <BiSolidQuoteLeft className="text-5xl text-white mb-5"></BiSolidQuoteLeft>
                                <p className="text-white  w-full text-sm italic">EdenEnclave exceeds in landscaping. Creative designs and expert maintenance elevated our Grand Horizon Hotel outdoors. Highly recommended!</p>
                                <div className=" flex items-center gap-4 pt-4">
